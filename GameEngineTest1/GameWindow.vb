Public Class GameWindow
    ...
    Private Sub MoveYoCrap()
        If MegamanXVelocity <> 0 Then  'If horizontal motion is not 0...
            If MegamanXVelocity > 0 AndAlso Megaman.Left < Width Then   'If the player is not out of bounds to the right...
                Megaman.Left = Megaman.Left + MegamanXVelocity
                If Megaman.Left > Width Then   'If the player was moved out of bounds to the right...
                    Megaman.Left = Width
        ...
        If MegamanAnimation <> 6 AndAlso MegamanAnimation <> 9 Then 'If vertical motion is not 0...
            ...
            If Megaman.Top > (Height - Megaman.Height) Then   'If the player is out of bounds under the bottom...
                Megaman.Top = (Height - Megaman.Height)
        ...
        Select Case MegamanAnimation
            ...
            Case = 6    'Warping In Right
                ...
                Else
                    ...
                    If Megaman.Top > (Height - Megaman.Height) Then   'If spawning in midair...
    ...
    Private Sub GameWindow_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        Select Case e.KeyCode   'Detects the held keys...
            ...
            Case Keys.Left
                ...
                MegamanLeft = True
            Case Keys.Up
                If Megaman.Top = (Height - Megaman.Height) Then   'If the player is on the ground...
                    MegamanYVelocity = (-19.6 * (Megaman.Width / 50))
